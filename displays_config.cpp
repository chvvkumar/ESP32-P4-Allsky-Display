...
// 3.4" display init commands
const lcd_init_cmd_t vendor_specific_init_3_4[] = {
...
const size_t vendor_specific_init_3_4_size = sizeof(vendor_specific_init_3_4) / sizeof(lcd_init_cmd_t);
...
// 4.0" display init commands
const lcd_init_cmd_t vendor_specific_init_4_0[] = {
    {0xE0, (uint8_t[]){0x00}, 1, 0},
...
const size_t vendor_specific_init_4_0_size = sizeof(vendor_specific_init_4_0) / sizeof(lcd_init_cmd_t);
