...
String WebConfig::generateImagePage() {
    ...
    html.reserve(400);
    html = "<div class='main'><div class='container'>";
    html += "<div id='imageApp'><div class='card'><p style='color:#94a3b8'>Loading image configuration…</p></div></div>";
    html += "<noscript><div class='card error'>This page requires JavaScript to configure image sources.</div></noscript>";
    html += "</div></div>";
    return html;
}
