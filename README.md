...
- **AllSky Module** - Dedicated [allsky_esp32round module](https://github.com/AllskyTeam/allsky-modules/tree/master/allsky_esp32round) by [Alex]([https://github.com/purnasth](https://github.com/Alex-developer)) for automatic image resizing for both display sizes
