...
/**
 * @file network_http_policy.h
 * @brief Pure decision functions for network_http.c -- redirect classification,
 ...
 * of the fetcher's control flow that can be pinned with a host-side truth
 * table without dragging in esp_http_client.
 */
